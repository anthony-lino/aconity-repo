...
geometry_path = '/CAD/cubes_Lydia_lab/flat_cubes.stl'

if os.path.exists(geometry_path):
    print(f"File exists: {geometry_path}")
else:
    print(f"File does NOT exist: {geometry_path}")
    # You can optionally exit or raise an error
    exit(1)

solidPart = pyslm.Part('cubes')
solidPart.setGeometry(geometry_path)
print(type(solidPart))
